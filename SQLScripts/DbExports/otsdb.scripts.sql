...
-- Dumping data for table otsdb.courseknowledgemap: ~11 rows (approximately)
...
REPLACE INTO `courseknowledgemap` (`CourseId`, `KnowledgeMapId`, `AssignBy`, `AssignOn`, `ModifyOn`) VALUES
	(1, 3, 1, '2015-08-19 15:47:41', NULL),
...
-- Dumping data for table otsdb.question: ~9 rows (approximately)
/*!40000 ALTER TABLE `question` DISABLE KEYS */;
REPLACE INTO `question` (`QuestionId`, `Text`, `Mark`, `QuestionTypeId`, `QuestionNatureType_id`, `CognitiveLevelType_id`) VALUES
	(9, 'Garden has taiwan cherry', NULL, 1, 1, 1),
	(10, 'Garden has rhododendron', NULL, 1, 1, 1),
	(11, 'Garden has golden dedron', NULL, 1, 1, 1),
	(12, 'Garden has broad leaf rocks', NULL, 1, 1, 1),
	(13, 'Plant has root', NULL, 1, 1, 1),
	(14, 'Plant has steam', NULL, 1, 1, 1),
	(15, 'Plant has leaf', NULL, 1, 1, 1),
	(16, 'Which of the following statement is true about leaf', NULL, 2, 1, 1),
	(17, 'Which of the following statements are true about leaf', NULL, 3, 1, 1);
/*!40000 ALTER TABLE `question` ENABLE KEYS */;

-- Dumping data for table otsdb.questionlineitem: ~23 rows (approximately)
...
REPLACE INTO `questionlineitem` (`QuestionLineItemId`, `Text`, `IsCorrect`, `Question_id`) VALUES
	...
	(29, 'True', NULL, 15),
	(30, 'False', NULL, 15),
	(31, 'Leaf has shape', NULL, 16),
	(32, 'Leaf has margin', NULL, 16),
	(33, 'Leaf does not have shape', NULL, 16),
	(34, 'Leaf does not have margin', NULL, 16),
	(35, 'Leaf has sprout', NULL, 16),
	(36, 'Leaf does not have sprout', NULL, 16),
	(37, 'Leaf has shape', NULL, 17),
	(38, 'Leaf has margin', NULL, 17),
	(39, 'Leaf has sprout', NULL, 17);
...
-- Dumping data for table otsdb.testitem: ~7 rows (approximately)
...
REPLACE INTO `testitem` (`TestItemId`, `QuestionBankId`, `Text`, `Mark`, `CognitiveLevelTypeId`, `QuestionNatureType`, `QuestionType`, `Test_id`) VALUES
	(5, 9, 'Garden has taiwan cherry', 0, 1, 1, 1, 1),
	(6, 12, 'Garden has broad leaf rocks', 0, 1, 1, 1, 1),
	(7, 10, 'Garden has rhododendron', 0, 1, 1, 1, 1),
	(8, 11, 'Garden has golden dedron', 0, 1, 1, 1, 1),
	(9, 16, 'Which of the following statement is true about leaf', 0, 1, 1, 2, 1),
	(10, 17, 'Which of the following statements are true about leaf', 0, 1, 1, 3, 1),
	(11, 14, 'Plant has steam', 0, 1, 1, 1, 1);
/*!40000 ALTER TABLE `testitem` ENABLE KEYS */;

-- Dumping data for table otsdb.testitemoption: ~19 rows (approximately)
...
REPLACE INTO `testitemoption` (`TestItemOptionId`, `Text`, `IsCorrect`, `TestItem_id`) VALUES
	...
	(15, 'True', 0, 8),
	(16, 'False', 0, 8),
	(17, 'Leaf has shape', 0, 9),
	(18, 'Leaf has margin', 0, 9),
	(19, 'Leaf does not have shape', 0, 9),
	(20, 'Leaf does not have margin', 0, 9),
	(21, 'Leaf has sprout', 0, 9),
	(22, 'Leaf does not have sprout', 0, 9),
	(23, 'Leaf has shape', 0, 10),
	(24, 'Leaf has margin', 0, 10),
	(25, 'Leaf has sprout', 0, 10),
	(26, 'True', 0, 11),
	(27, 'False', 0, 11);
