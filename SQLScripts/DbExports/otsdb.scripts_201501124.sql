...
-- Dumping data for table otsdb.studenttestanswersheet: ~4 rows (approximately)
...
REPLACE INTO `studenttestanswersheet` (`StudentTestAnswerSheetId`, `A`, `B`, `C`, `D`, `IsCorrect`, `TotalCorrectAnswers`, `StudentId`, `TestItemId`, `TestId`) VALUES
	(25, 1, 0, 0, 0, 1, 1, 3, 24, 1),
	(26, 1, 0, 0, 0, 1, 1, 3, 25, 1),
	(27, 1, 0, 0, 0, 1, 1, 3, 28, 1),
	(28, 0, 0, 0, 1, 0, 0, 3, 26, 1),
	(29, 1, 0, 0, 0, 1, 1, 5, 24, 1),
	(30, 1, 0, 0, 0, 1, 1, 5, 25, 1),
	(31, 1, 0, 0, 0, 1, 1, 5, 28, 1),
	(32, 1, 1, 1, 0, 1, 3, 5, 26, 1);
...
REPLACE INTO `studenttesthistory` (`StudentTestHistoryId`, `TestId`, `StudentId`, `StartDate`, `EndDate`, `TotalMark`) VALUES
	(16, 1, 3, '2015-11-24 15:55:24', '2015-11-24 15:55:38', 50),
	(17, 1, 5, '2015-11-24 15:57:07', '2015-11-24 15:57:32', 100);
