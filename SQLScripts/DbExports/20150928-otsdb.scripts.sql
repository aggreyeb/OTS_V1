...
INSERT INTO `question` (`QuestionId`, `Text`, `Mark`, `QuestionTypeId`, `QuestionNatureType_id`, `CognitiveLevelType_id`) VALUES
...
INSERT INTO `questionlineitem` (`QuestionLineItemId`, `Text`, `IsCorrect`, `Question_id`) VALUES
	(117, 'True', NULL, 35),
	(118, 'False', NULL, 35),
	(119, 'True', NULL, 36),
	(120, 'False', NULL, 36),
...
-- Dumping data for table otsdb.studentcourseregistration: ~1 rows (approximately)
...
INSERT INTO `teachercoursetest` (`CourseTestId`, `CreatedOn`, `CourseId`, `TestId`, `TeacherId`) VALUES
...
INSERT INTO `test` (`TestId`, `Name`, `TotalMark`, `NumberOfQuestion`, `StartDate`, `StartTime`, `EndTime`, `IsActivated`) VALUES
...
INSERT INTO `testanswersheet` (`TestAnswerSheetId`, `LineNumber`, `A`, `B`, `C`, `D`, `TestId`, `TestItemId`) VALUES
	(22, 0, 1, 0, 0, 0, 1, 24),
	(23, 0, 0, 0, 0, 0, 1, 25),
	(24, 0, 0, 0, 0, 0, 1, 26),
	(26, 0, 0, 0, 0, 0, 1, 28);
...
INSERT INTO `testitem` (`TestItemId`, `QuestionBankId`, `Text`, `Mark`, `CognitiveLevelTypeId`, `QuestionNatureType`, `QuestionType`, `Test_id`) VALUES
	(24, 35, 'Plant has root', 0, 1, 1, 1, 1),
	(25, 36, 'Plant has steam', 0, 1, 1, 1, 1),
	(26, 42, 'Which of the following are vegetative organ', 0, 4, 1, 3, 1),
	(28, 39, 'Leaf has shape', 0, 1, 1, 1, 1);
...
INSERT INTO `testitemoption` (`TestItemOptionId`, `Text`, `IsCorrect`, `TestItem_id`) VALUES
	(49, 'True', 1, 24),
	(50, 'False', 0, 24),
	(51, 'True', 0, 25),
	(52, 'False', 0, 25),
