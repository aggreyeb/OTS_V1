...
REPLACE INTO `courseknowledgemap` (`CourseId`, `KnowledgeMapId`, `AssignBy`, `AssignOn`, `ActionText`, `CanEnableSelect`) VALUES
	...
	(2, 3, 1, '2016-02-10 16:53:36', 'Selected', 0),
...
-- Dumping data for table otsdb.user: ~5 rows (approximately)
...
-- Dumping data for table otsdb.useraccount: ~5 rows (approximately)
