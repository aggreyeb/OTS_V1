...
INSERT IGNORE INTO `question` (`QuestionId`, `Text`, `Mark`, `QuestionTypeId`, `QuestionNatureType_id`, `CognitiveLevelType_id`, `Test_id`) VALUES
	(1, 'Taiwan Cherry', NULL, 1, 1, 2, 1);
/*!40000 ALTER TABLE `question` ENABLE KEYS */;

-- Dumping data for table otsdb.questionlineitem: ~4 rows (approximately)
...
INSERT IGNORE INTO `questionlineitem` (`QuestionLineItemId`, `Text`, `IsCorrect`, `Question_id`) VALUES
	(1, 'The shape of Taiwan Cherry\'s is aristate', 1, 1),
	(2, 'The venation of Taiwan Cherry\'s is palmate', 1, 1),
	(3, 'The margin of Taiwan Cherry\'s is serrate', NULL, 1),
	(4, 'The arragement of Taiwan Cherry\'s is alternate', NULL, 1);
...
INSERT IGNORE INTO `studentcourseregistration` (`StudentId`, `CourseId`, `Date`) VALUES
	(21, 1, '2015-03-18 22:58:18'),
	(21, 2, '2015-03-18 22:58:18'),
	(39, 1, '2015-03-17 20:04:37'),
	(39, 2, '2015-03-17 20:04:37');
...
-- Dumping data for table otsdb.teachercoursetest: ~1 rows (approximately)
...
INSERT IGNORE INTO `teachercoursetest` (`CourseTestId`, `CreatedOn`, `CourseId`, `TestId`, `TeacherId`) VALUES
	(1, '2015-03-07 12:59:33', 1, 1, 1),
	(2, '2015-03-17 21:43:31', 1, 2, 1);
...
-- Dumping data for table otsdb.test: ~1 rows (approximately)
/*!40000 ALTER TABLE `test` DISABLE KEYS */;
INSERT IGNORE INTO `test` (`TestId`, `Name`, `TotalMark`, `NumberOfQuestion`, `StartDate`, `StartTime`, `EndTime`, `IsActivated`) VALUES
	(1, 'Introduction to Botany level 1', 10, 10, '2015-03-02 00:00:00', '10:00', '12:30', 0),
	(2, 'Introduction  to Botany Level 2', 20, 20, '2015-03-30 00:00:00', '10:30', '11:45', 0);
...
-- Dumping data for table otsdb.user: ~8 rows (approximately)
...
INSERT IGNORE INTO `user` (`UserId`, `Email`, `Phone`, `UserTypeId`, `UserAccountId`, `FirstName`, `LastName`, `Number`, `Street`, `City`, `Province`, `DepartmentTypeId`) VALUES
	(1, 'ots@ots.com', '222-222-222', 3, 1, 'Maiga', 'Chang', NULL, NULL, NULL, NULL, NULL),
	(2, 'eb@ots.com', '333-333-333', 3, 2, 'Ebenezer', 'Aggrey', NULL, NULL, NULL, NULL, NULL),
	(21, 'ms@ots.com', '908-987-7865', 2, 21, 'Mark', 'Smitty', NULL, NULL, NULL, NULL, NULL),
	(33, 'admin@ots.com', '209-098-0987', 1, 33, 'admin', 'admin', NULL, NULL, NULL, NULL, NULL);
/*!40000 ALTER TABLE `user` ENABLE KEYS */;

-- Dumping data for table otsdb.useraccount: ~8 rows (approximately)
/*!40000 ALTER TABLE `useraccount` DISABLE KEYS */;
INSERT IGNORE INTO `useraccount` (`UserAccountId`, `UserName`, `Password`, `IsLocked`) VALUES
	(1, 'maiga', 'maiga', 0),
	(2, 'eb', 'eb', 0),
	(21, 'ms@ots.com', 'T12LW', 0),
	(33, 'admin@ots.com', 'admin', 0);
