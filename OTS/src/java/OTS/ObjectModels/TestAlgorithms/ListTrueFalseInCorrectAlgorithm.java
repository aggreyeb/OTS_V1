 ...
 * @author MEA
 */
public class ListTrueFalseInCorrectAlgorithm extends TrueFalseAlgorithm{

    public ListTrueFalseInCorrectAlgorithm(DataSource dataSource, String name, ConceptRelationMap conceptRelationMap) {
