 ...
 * @author aggreeb
 */
public class ListSingleAnswerMultipleChoiceAlgorithm extends CompositeAlgorithm {
 private String myName="ListMultipleChoice-SingleAnswerCorrect";
    public ListSingleAnswerMultipleChoiceAlgorithm(DataSource dataSource, String name) {
