 ...
 * @author aggreeb
 */
public class DescribeMultipleAnswerMultipleChoiceAlgorithm extends CompositeAlgorithm {

    public DescribeMultipleAnswerMultipleChoiceAlgorithm(DataSource dataSource, String name, String appendLastQuestionLineItem) {
